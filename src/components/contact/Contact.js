...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    else if (email === "") setErrMsg("Please give your Email!");
    else if (!emailValidation(email)) setErrMsg("Give a valid Email!");
    else if (subject === "") setErrMsg("Please give your Subject!");
